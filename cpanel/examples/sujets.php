                      ...
                      <tbody>
                        ...
                        <?php 
                            foreach($sujets as $key => $sujet){
                              echo "<tr>";
                                echo "<td>".$sujet["id"]."</td>";
                                echo "<td>".$sujet["sujet"]."</td>";
                                echo "<td>".$sujet["user_id"]."</td>";
                                echo "<td>".substr($sujet["description"],0,10)."...</td>";
                                echo  "<td>".$sujet["cat"]."</td>";
                                echo '<td class="text-primary">';
                                  ...
                                  echo'<a href="actions/delSuj.php?id='.$sujet["id"].'"><img src="../assets/img/delete-24px.svg"></a>';
                               echo '</td>';
                                echo "</tr>";
                            }
                        ?>
